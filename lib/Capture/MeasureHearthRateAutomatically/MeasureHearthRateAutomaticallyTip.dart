...
void main(){
  runApp(MeasureHearthRateAutomaticallyTip());
}

class MeasureHearthRateAutomaticallyTip extends StatefulWidget {
  @override
  _MeasureHearthRateAutomaticallyTipState createState() => _MeasureHearthRateAutomaticallyTipState();
}

class _MeasureHearthRateAutomaticallyTipState extends State<MeasureHearthRateAutomaticallyTip> {
  @override
  void initState() {
      Future.delayed(Duration(milliseconds: 2000), () {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) =>  HearthRateReadingInterface()),
        );
      });
