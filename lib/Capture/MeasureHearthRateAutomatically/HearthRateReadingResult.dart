...
void main(){
  runApp(HearthRateReadingResult());
}

class HearthRateReadingResult extends StatefulWidget {
  HearthRateReadingResult({super.key});
  @override
  _IrregularECGGraphCompleteScreen createState() => _IrregularECGGraphCompleteScreen();
}

class _IrregularECGGraphCompleteScreen extends  State<HearthRateReadingResult> {
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Row(
            children: [
              InkWell(
          onTap: () => popMultipleTimes(context, 1),
          child: 
              Container(
              ...
              Column(
                children: [
                  ...
                  ClipRRect(
                    ...
                    child: Image.asset("assets/images/hearth_result_graph.png"),
                  ),
                  SizedBox(height: getFontSize(15, context),),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.start,
