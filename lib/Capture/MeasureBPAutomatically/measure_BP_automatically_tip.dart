...
import 'BPReadingInterface.dart';

void main(){
  runApp(MeasureBPAutomaticallyTip());
}

class MeasureBPAutomaticallyTip extends StatefulWidget {
  @override
  _MeasureBPAutomaticallyTipState createState() => _MeasureBPAutomaticallyTipState();
}

class _MeasureBPAutomaticallyTipState extends State<MeasureBPAutomaticallyTip> {
    ...
    // TODO: implement initState
      Future.delayed(Duration(milliseconds: 2000), () {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) =>  BPReadingInterface()),
        );
      });
    super.initState();
  }
